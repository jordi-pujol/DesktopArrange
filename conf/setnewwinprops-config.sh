...
Rule {
	...
	check_title="title"
	# Type of the window.
	check_type="WINDOW_NORMAL", "WINDOW_TOOLBAR", etc.
	# Application which created the window.
	check_application="/usr/bin/qemu"
	# Class of the window.
	check_class="QEMU"
	...
	check_desktop_workarea="1920x1080"
	...
	set_maximized_horizontally="y|yes|enable|true|1  n|no|disable|false|0"
	# Maximize vertically.
	set_maximized_vertically="y|yes|enable|true|1  n|no|disable|false|0"
